...
export default function App() {
  ...
  const [settings, setSettings] = useState<Settings>({
    ...
    appsScriptUrl: 'https://script.google.com/macros/s/AKfycbykYeGI-EX7ZQNR9SeFXq7yfeh6laHphcMyn-are__tcFfV7Px7kMy5-nAEQwCBW1Ry2w/exec',
    ...
    if (saved) {
      try {
        ...
        setSettings({
          ...
          appsScriptUrl: parsed.appsScriptUrl || 'https://script.google.com/macros/s/AKfycbykYeGI-EX7ZQNR9SeFXq7yfeh6laHphcMyn-are__tcFfV7Px7kMy5-nAEQwCBW1Ry2w/exec',
